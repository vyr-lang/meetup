...
2. Set any required API tokens in your environment
3. Create an agenda file (one item per line)

## Run
```bash
python3 meetup.py --mailing M0001 --agents agents.example.json --agenda agenda.example.txt --notes meeting-notes.md
```
...
## Notes
- No API keys are stored in the repo. Use environment variables referenced by `auth_env`.
